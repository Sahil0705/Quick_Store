...
error_reporting(0);
    ...
    echo $folder;
  	...
  	$query="insert into cart values ('$_SESSION[user_name]','$folder','$_SESSION[type]','$_SESSION[name]','$_SESSION[price]','$_SESSION[nprice]','$_SESSION[past]','$_SESSION[offer]',$_SESSION[count])";
